...
# 13 "./ECU/BUTTON/../../MCAL/GPIO/hal_gpio.h"
# 1 "./ECU/BUTTON/../../MCAL/GPIO/../mcal_std_types.h" 1
# 16 "./ECU/BUTTON/../../MCAL/GPIO/../mcal_std_types.h"
...
# 13 "./ECU/BUTTON/../../MCAL/GPIO/hal_gpio.h" 2
# 32 "./ECU/BUTTON/../../MCAL/GPIO/hal_gpio.h"
typedef enum{
    GPIO_PORTA,
    GPIO_PORTB,
    GPIO_PORTC,
...
Relay_t relay1 = { .Port = GPIO_PORTC, .Pin = GPIO_PIN0, .Status = 0};
Relay_t relay2 = { .Port = GPIO_PORTC, .Pin = GPIO_PIN1, .Status = 0};
    ...
    while(1){
        ...
        if((BUTTON_PRESSED == status_two_motors) && (0 == flag_change_status_two_motors)){
            flag_change_status_two_motors = 1;
             _delay((unsigned long)((30)*(80000000UL/4000.0)));
