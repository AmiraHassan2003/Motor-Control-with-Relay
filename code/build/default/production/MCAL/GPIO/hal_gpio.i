...
Std_ReturnType gpio_pin_direction_initialize(const pin_config_t *_pin_config)
{
    Std_ReturnType ret = (Std_ReturnType)1;
    if((((void*)0) == _pin_config) || (7 < _pin_config->Pin) || (4 < _pin_config->Port)){
        ret = (Std_ReturnType)1;
    }
    else{
        switch(_pin_config->Direction){
            case GPIO_INPUT:
                (*tris_registers[_pin_config->Port] |= ( 1 << _pin_config->Pin ));
                ret = (Std_ReturnType)1;
                break;
            case GPIO_OUTPUT:
                (*tris_registers[_pin_config->Port] &= ~( 1 << _pin_config->Pin ));
...
{
    Std_ReturnType ret = (Std_ReturnType)1;
    if((((void*)0) == _pin_config)||(((void*)0) == direction_status) || (7 < _pin_config->Pin)||(4 < _pin_config->Port)){
        ret = (Std_ReturnType)1;
    }
    else{
        *direction_status = (( *tris_registers[_pin_config->Port] >> _pin_config->Pin ) & 1);
    }
    return ret;
}
...
Std_ReturnType gpio_pin_write_logic(const pin_config_t *_pin_config, logic_t logic)
{
    ...
    if((((void*)0) == _pin_config) || (7 < _pin_config->Pin) || (4 < _pin_config->Port)){
        ...
        switch(logic){
            case GPIO_LOW:
                (*lat_registers[_pin_config->Port] &= ~( 1 << _pin_config->Pin ));
                ret = (Std_ReturnType)1;
                break;
            case GPIO_HIGH:
                (*lat_registers[_pin_config->Port] |= ( 1 << _pin_config->Pin ));
...
{
    Std_ReturnType ret = (Std_ReturnType)1;
    if((((void*)0) == _pin_config)||(((void*)0) == logic) || (7 < _pin_config->Pin)||(4 < _pin_config->Port)){
        ret = (Std_ReturnType)1;
    }
    else{
        *logic = (( *port_registers[_pin_config->Port] >> _pin_config->Pin ) & 1);
    }
    return ret;
}
